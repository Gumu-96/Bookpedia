...
/**
 * Custom serializer for BookWorkDto to handle the 'description' field which can be either a String
 * or an object with a 'value' field containing the description string.
 */
            ...
            when (val index = decodeElementIndex(descriptor)) {
                0 -> {
                    ...
                    description = if (element is JsonObject) {
                        decoder.json.decodeFromJsonElement(DescriptionDto.serializer(), element).value
